import xmlrpclib
from vt_manager_kvm.communication.northCommInterface import send_sync
from uuid import uuid4
from vt_manager_kvm.communication.utils.XmlHelper import *

rspec = open("/opt/ofelia/vt_manager_kvm/src/python/vt_manager_kvm/tests/provisioning/pruebaCreate.xml").read()
