...
MIDDLEWARE_CLASSES = (
    ...
    'vt_manager_kvm.common.middleware.basicauth.HTTPBasicAuthMiddleware',
    'vt_manager_kvm.common.middleware.sitelockdown.SiteLockDown',
    'vt_manager_kvm.common.middleware.thread_local.threadlocal',
)
...
AUTHENTICATION_BACKENDS = (
    'vt_manager_kvm.common.backends.remoteuser.NoCreateRemoteUserBackend',
...
#
ROOT_URLCONF = 'vt_manager_kvm.urls'

#
# Path to the template (.html files) folder(s).
#
TEMPLATE_DIRS = (
    join(SRC_DIR, 'python/vt_manager_kvm/views/templates/default'),
)
...
TEMPLATE_CONTEXT_PROCESSORS = [
    ...
    'vt_manager_kvm.common.utils.context_processors.contextSettingsInTemplate',
]

#
# Path to the static content (images, css, js) folders.
#
MEDIA_ROOT = join(SRC_DIR+"python/vt_manager_kvm/views/static/", "media")
...
#
INSTALLED_APPS = (
    'vt_manager_kvm.common.longer_username',
    'django.contrib.auth',
    ...
    'django_extensions',
    'vt_manager_kvm.common.rpc4django',
    'vt_manager_kvm.common.defaultsite',
    'vt_manager_kvm.common.commands',
    'registration',
    'django_evolution',
    'vt_manager_kvm.models',
    'vt_manager_kvm',
