...
from vt_manager_kvm.communication.sfa.util.faults import MissingAuthority
#from vt_manager_kvm.communication.sfa.util.vt_manager_kvm.communication.sfa.ogging import logger
from vt_manager_kvm.communication.sfa.util.xrn import get_leaf, get_authority, hrn_to_urn, urn_to_hrn
from vt_manager_kvm.communication.sfa.trust.certificate import Keypair
from vt_manager_kvm.communication.sfa.trust.credential import Credential
from vt_manager_kvm.communication.sfa.trust.gid import GID, create_uuid
...
#from vt_manager_kvm.communication.sfa.setUp import setup_config as auth_config
##
