...
from vt_manager_kvm.communication.sfa.rspecs.elements.versions.pgv2Interface import PGv2Interface     
...
from vt_manager_kvm.communication.sfa.rspecs.elements.versions.ocfvtSlivers import OcfVtSlivers
