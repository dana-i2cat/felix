...
from vt_manager_kvm.communication.sfa.rspecs.version import RSpecVersion
#from vt_manager_kvm.communication.sfa.rspecs.versions.pgv2 import PGv2
#from vt_manager_kvm.communication.sfa.rspecs.elements.versions.pgv2Link import PGv2Link
#from vt_manager_kvm.communication.sfa.rspecs.elements.versions.pgv2Node import PGv2Node
#from vt_manager_kvm.communication.sfa.rspecs.elements.versions.pgv2SliverType import PGv2SliverType

from  vt_manager_kvm.communication.sfa.rspecs.elements.versions.ocfvtNode import OcfVtNode
 
class OcfVt(RSpecVersion):
    type = 'OcfVt'
    content_type = 'ad'
    version = '1'
    schema = 'https://github.com/fp7-ofelia/ocf/blob/ocf.rspecs/schema.xsd' #'/opt/ofelia/vt_manager_kvm/src/python/vt_manager_kvm/communication/sfa/tests/schema.xsd'#'http://www.protogeni.net/resources/rspec/2/ad.xsd'
...
class OcfVtAd(OcfVt):
    enabled = True
    content_type = 'ad'
    schema = 'https://github.com/fp7-ofelia/ocf/blob/ocf.rspecs/server_schema.xsd'#'/opt/ofelia/vt_manager_kvm/src/python/vt_manager_kvm/communication/sfa/tests/server_schema.xsd'#'http://www.protogeni.net/resources/rspec/2/ad.xsd'
    ...
    #template = '<rspec type="advertisement" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.protogeni.net/resources/rspec/2 /opt/ofelia/vt_manager_kvm/src/python/vt_manager_kvm/communication/sfa/tests/server_schema.xsd http://www.protogeni.net/resources/rspec/2/ad.xsd"/>'

class OcfVtRequest(OcfVt):
    enabled = True
    content_type = 'request'
    schema = 'https://github.com/fp7-ofelia/ocf/blob/ocf.rspecs/vm_schema.xsd'#'/opt/ofelia/vt_manager_kvm/src/python/vt_manager_kvm/communication/sfa/tests/vm_schema.xsd'#'http://www.protogeni.net/resources/rspec/2/ad.xsd'
    ...
    #template = '<rspec type="request" xmlns="http://www.protogeni.net/resources/rspec/2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.protogeni.net/resources/rspec/2 /opt/ofelia/vt_manager_kvm/src/python/vt_manager_kvm/communication/sfa/tests/vm_schema.xsd http://www.protogeni.net/resources/rspec/2/ad.xsd "/>'
...
class OcfVtManifest(OcfVt):
    ...
    schema = 'https://github.com/fp7-ofelia/ocf/blob/ocf.rspecs/server_schema.xsd' #'/opt/ofelia/vt_manager_kvm/src/python/vt_manager_kvm/communication/sfa/tests/server_schema.xsd'#'http://www.protogeni.net/resources/rspec/2/manifest.xsd'
    ...
    #template = '<rspec type="manifest" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.protogeni.net/resources/rspec/2 /opt/ofelia/vt_manager_kvm/src/python/vt_manager_kvm/communication/sfa/tests/server_schema.xsd http://www.protogeni.net/resources/rspec/2/ad.xsd"/>'
#    template = '<rspec type="manifest" xmlns="http://www.protogeni.net/resources/rspec/2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.protogeni.net/resources/rspec/2 /opt/ofelia/vt_manager_kvm/src/python/vt_manager_kvm/communication/sfa/tests/server_schema.xsd http://www.protogeni.net/resources/rspec/2/ad.xsd"/>'
     


if __name__ == '__main__':
    from vt_manager_kvm.communication.sfa.rspecs.rspec import RSpec
    from vt_manager_kvm.communication.sfa.rspecs.rspec_elements import *
