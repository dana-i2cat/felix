import os
from vt_manager_kvm.communication.sfa.util.faults import InvalidRSpec, UnsupportedRSpecVersion
from vt_manager_kvm.communication.sfa.rspecs.version import RSpecVersion 
#from vt_manager_kvm.communication.sfa.util.sfalogging import logger    
...
class VersionManager:
    ...
    def load_versions(self):
        ...
        versions_module_path = 'vt_manager_kvm.communication.sfa.rspecs.versions'
		...
		#XXX I do not really understand why the otrer modules works except the OCF module	
	        module = __import__('vt_manager_kvm.communication.'+module_path, fromlist='vt_manager_kvm.communication.'+module_path)
