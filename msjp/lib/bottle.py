...
if __name__ == '__main__':
    ...
    _cmd_parser = OptionParser(usage="usage: %prog [options] package.module:module")
...
class Route(object):
    ...
    def get_config(self, key, default=None):
        """ Lookup a config field and return its value, first checking the
            route.config, then route.module.config."""
...
class Bottle(object):
    ...
    def __init__(self, catchall=True, autojson=True):
        ...
        #: A :class:`ConfigDict` for module specific configuration.
    ...
    def mount(self, prefix, app, **options):
        """ Mount an application (:class:`Bottle` or plain WSGI) to a specific
            ...
            :param module: an instance of :class:`Bottle` or a WSGI application.
    ...
    def merge(self, routes):
        """ Merge the routes of another :class:`Bottle` application or a list of
            ...
            'owner', meaning that the :data:`Route.module` attribute is not
            changed. """
    ...
    def add_route(self, route):
        """ Add a route object, but do not change the :data:`Route.module`
            attribute."""
...
class BaseRequest(object):
    ...
    @DictProperty('environ', 'bottle.module', read_only=True)
    def app(self):
    ...
    @property
    def url(self):
        """ The full request URI including hostname and scheme. If your module
...
def make_default_app_wrapper(name):
    """ Return a callable that relays calls to the current default module. """
...
def run(app=None, server='wsgiref', host='127.0.0.1', port=8080,
    ...
    """ Start a server instance. This method blocks until the server terminates.
        ...
        :param module: WSGI application or target string supported by
...
# Initialize module stack (create first empty Bottle module)
