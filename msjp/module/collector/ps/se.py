...
from module.common.se_md import create_monitoring_data_xml,DBUploader
from module.common.util import to_array

# constants
COL_NAME = 'monitoring-data(se)'
...
class MonitoringDataSE():
    ...
    def __aggregate(self,md_dict,timestamp):
        ...
        agg_val_list = []
        agg_val_dict = dict()
        for item_dict in config.ps_se_mon_item_list:
