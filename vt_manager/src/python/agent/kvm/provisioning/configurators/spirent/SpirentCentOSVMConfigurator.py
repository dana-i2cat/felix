...
'''
	...
	Spirent CentOS VM Configurator
'''
import os
import jinja2 
import re
from kvm.provisioning.HdManager import HdManager
from settings.settingsLoader import OXA_KVM_SERVER_KERNEL,OXA_KVM_SERVER_INITRD, OXA_REDHAT_INTERFACES_FILE_LOCATION, OXA_REDHAT_HOSTNAME_FILE_LOCATION, OXA_SPIRENT_NPORTS_PER_GROUP, OXA_SPIRENT_NTPSERVER, OXA_SPIRENT_NPORTGROUPS, OXA_SPIRENT_LSERVER, OXA_SPIRENT_STCA_INI_PATH, OXA_SPIRENT_ADMIN_CONF_PATH
