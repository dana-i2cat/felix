...
class_by_code = {
    1: GENIv3BadArgsError,
    2: GENIv3GeneralError,
    3: GENIv3ForbiddenError,
    4: GENIv3BadVersionError,
    5: GENIv3ServerError,
    6: GENIv3TooBigError,
    7: GENIv3RefusedError,
    8: GENIv3TimedoutError,
    9: GENIv3DatabaseError,
    10: GENIv3RPCError,
    11: GENIv3UnavailableError,
    12: GENIv3SearchFailedError,
    13: GENIv3OperationUnsupportedError,
    14: GENIv3BusyError,
    15: GENIv3ExpiredError,
    16: GENIv3InProgressError,
    17: GENIv3AlreadyExistsError,
    24: GENIv3VLANUnavailableError,
}
