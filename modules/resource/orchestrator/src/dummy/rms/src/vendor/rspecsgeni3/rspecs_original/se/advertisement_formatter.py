from rspecs.tn.advertisement_formatter import TNRMv3AdvertisementFormatter,\
        DEFAULT_XMLNS, DEFAULT_XS, DEFAULT_SHARED_VLAN,\
        DEFAULT_AD_SCHEMA_LOCATION
from lxml import etree


class SEv3AdvertisementFormatter(TNRMv3AdvertisementFormatter):
