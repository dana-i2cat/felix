...
logger = amsoil.core.log.getLogger('ryugeniv3delegate')

GENIv3DelegateBase = pm.getService('geniv3delegatebase')
geni_ex = pm.getService('geniv3exceptions')


class RyuDelegate(GENIv3DelegateBase):
    URN_PREFIX = 'urn:RYU_AM'
    MANIFEST_URL = 'http://www.geni.net/resources/rspec/ext/ryu/3'

    def __init__(self):
        super(RyuDelegate, self).__init__()
        logger.info("RyuDelegate successfully initialized!")
