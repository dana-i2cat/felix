...
import core
logger=core.log.getLogger("crmdelegategeniv3")

from handler.geni.v3 import exceptions as geni_ex
from delegate.geni.v3.computing import computing_rm_adaptor

class ComputingGENI3Delegate(GENIv3DelegateBase):
    """
    """
    
    URN_PREFIX = 'urn:C_RM' # TODO should also include a changing component, identified by a config key
    
    def __init__(self):
        super(ComputingGENI3Delegate, self).__init__()
        self._resource_manager = computing_rm_adaptor
