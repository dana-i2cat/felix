...
class Sliver(object):
    def __init__(self, component_id, sliver_type="emulab-xen",
                 disk_image="default", ram="512", disk="8", cores="1",
                 cm_id=None, client_id=None, exclusive=None):
        self.sliver = {"component_id": component_id, # Server
                        "sliver_type": sliver_type,
                        "disk_image": disk_image,
                        "ram": ram,
                        "disk": disk,
                        "cores": cores,
                        "component_manager_id": cm_id,
                        "client_id": client_id,
                        "exclusive": exclusive
                        }
