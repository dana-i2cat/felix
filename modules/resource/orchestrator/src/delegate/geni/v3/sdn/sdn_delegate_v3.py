...
import core
logger=core.log.getLogger("sdnrmdelegategeniv3")

from handler.geni.v3 import exceptions as geni_ex
from delegate.geni.v3.sdn import sdn_rm_adaptor

class SDNGENI3Delegate(GENIv3DelegateBase):
    """
    """
    
    URN_PREFIX = 'urn:SDN_RM' # TODO should also include a changing component, identified by a config key
    
    def __init__(self):
        super(SDNGENI3Delegate, self).__init__()
        self._resource_manager = sdn_rm_adaptor
