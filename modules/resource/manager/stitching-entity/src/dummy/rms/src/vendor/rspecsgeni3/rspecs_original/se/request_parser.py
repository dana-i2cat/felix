from rspecs.tn.request_parser import TNv3RequestParser
from rspecs.commons_se import SELink


class SEv3RequestParser(TNv3RequestParser):
    def __init__(self, from_file=None, from_string=None):
        super(SEv3RequestParser, self).__init__(from_file, from_string)
