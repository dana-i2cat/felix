...
class DBUploader:
    ...
    def __create_value_dict(self,nw,node,param_type,ts,val):
    ...
    def __upload_monitoring_data(self,**val_dict):
        ...
        #---example---
        # echo 'timestamp,1414617024,network_name,hoge-nw,node_name,hoge-node,type,status,value,1' |
        # /hoge/script/uploader.pl -m 'network_name,node_name,type'\
        ...
        key_dict = {'key_ts':const.DB_COL_TIME_STAMP,'key_nw':const.DB_COL_NW_NAME
                      ,'key_node':const.DB_COL_NODE_NAME
    ...
    def upload_monitoring_data_all(self,md_xml):
        try:
            ...
            for topol_dict in mon_data_dict[const.XML_TAG_TOPOL]:
                ...
                for node in node_list:
                    node_id = node[const.XML_ATTR_ID]
                    param_list = node[const.XML_TAG_PARAM]
                    ...
                    for param in param_list:
                        ...
                        for val in val_list:
                            ...
                            # create value dictionary.
                            val_dict = self.__create_value_dict(nw_name,node_id,param_type,time_stamp,val_text)
